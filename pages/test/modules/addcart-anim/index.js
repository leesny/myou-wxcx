...
Page({
  ...
  goodsItemAddTap: function (e) {    
    let finger = {};
    finger['x'] = e.detail.touch.touches["0"].clientX / wx.getSystemInfoSync().windowWidth * 750;//点击X的位置
    finger['y'] = e.detail.touch.touches["0"].clientY / wx.getSystemInfoSync().windowWidth * 750;//点击Y的位置
    
    App.utils.startAddShopAnimation([{ x: 60, y: 750 * wx.getSystemInfoSync().windowHeight / wx.getSystemInfoSync().windowWidth - 80 }, finger], this)
  },
